/**
 * Agente Flávio - Claude Haiku 4.5
...
// System prompt do Flávio é carregado dinamicamente
...
/**
 * Cliente Flávio - Interface simplificada
 */
export class FlavioAgent {
  /**
 ...
 */
export async function createFlavioAgent(): Promise<FlavioAgent> {
  if (!process.env.ANTHROPIC_API_KEY) {
    throw new Error('ANTHROPIC_API_KEY not found in environment variables');
  }

  return new FlavioAgent();
}

export default createFlavioAgent;
